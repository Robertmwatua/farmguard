...
self.addEventListener('push', (event) => {
  let data = { title: 'FarmGuard AI', body: 'New agricultural advisory!' };
  if (event.data) {
    try {
      data = event.data.json();
    } catch {
      data = { title: 'FarmGuard AI', body: event.data.text() };
    }
  }
...
// Notification click behavior (focuses or opens a window)
